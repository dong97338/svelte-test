...
const context = [
  {
    role: 'system',
    content:
      '당신은 요리법을 제공하는 요리사입니다. \n\n사용자가 제공한 재료 목록과 식사 유형, 매운 음식 여부를 토대로 개인화된 요리와 그 재료 레시피를 제시합니다. 제외 음식은 빼고 추천합니다.\n\n- 레시피 섹션을 마지막으로 요약을 덧붙이지 마세요.'
  },
  {
    role: 'user',
    content:
      '재료: 고추기름, 전분, 양파, 레몬, 닭다리살 정육, 간장, 숙주, 마늘, 건고추, 고춧가루, 새우, 홍합, 식용유, 사과, 설탕, 청양고추, 다시마, 대파, 생강, 식용유, 홍고추, 청주, 달걀, 매실청, 소금, 후추, 맛술\n식사 유형: 안주\n매운 음식: O\n제외 음식: 깐풍기'
  },
  {
    role: 'assistant',
    content://4인분, 1/2 3개 -> 1인분
  ...
  },
  {
    role: 'user',
    content:
      '재료: 숙주, 고추기름, 레몬, 사과, 대파, 홍합, 홍고추, 생강, 청양고추, 식용유, 다시마, 달걀, 후추, 설탕, 매실청, 맛술, 고춧가루, 소금, 식용유, 건고추, 청주, 간장, 양파, 마늘, 전분, 닭다리살 정육, 새우\n식사 유형: 안주\n매운 음식: O\n제외 음식: '
  },
  {
    role: 'assistant',
    content://4인분, 1/2 1개
  ...
  },
  {
    role: 'user',
    content:
      '재료: 매실청, 대파, 레몬, 후추, 홍고추, 식용유, 고춧가루, 전분, 숙주, 홍합, 식용유, 사과, 새우, 양파, 닭다리살 정육, 마늘, 고추기름, 청양고추, 건고추, 청주, 소금, 다시마, 간장, 맛술, 달걀, 생강, 설탕\n식사 유형: 밑반찬\n매운 음식: X\n제외 음식: 매콤 홍합볶음, 깐풍기'
  },
  {
    role: 'assistant',
    content://양 안정해짐
  ...
  },
  {
    role: 'user',
    content:
      '재료: 무채, 청고추, 오징어, 마늘, 돼지고기, 양파, 깻잎, 생강, 양파, 참기름, 월계수, 붉은고추, 통깨, 팽이버섯, 맛술, 설탕, 고춧가루, 올리고당, 청주, 굴, 대파, 진간장, 쪽파, 맛술, 멸치액젓, 소금, 당근, 알배추, 굴소스, 고추장, 된장, 후추\n식사 유형: 저녁식사\n매운 음식: O\n제외 음식: '
  },
  {
    role: 'assistant',
    content://양 모름 2~4인분(3인분), 1/2 3개, 1/4 1개
  ...
  },
  {
    role: 'user',
    content:
      '재료: 당근, 고추장, 소금, 양파, 참기름, 월계수, 된장, 청고추, 양파, 후추, 붉은고추, 마늘, 대파, 알배추, 멸치액젓, 맛술, 고춧가루, 진간장, 설탕, 생강, 굴소스, 오징어, 무채, 쪽파, 깻잎, 올리고당, 통깨, 팽이버섯, 맛술, 청주, 굴, 돼지고기\n식사 유형: 저녁식사\n매운 음식: X\n제외 음식: 오삼불고기 덮밥'
  },
  {
    role: 'assistant',
    content://2~3인분 4232
  ...
  },
  {
    role: 'user',
    content:
      '재료: 올리고당, 소금, 통깨, 간장, 양파, 식용유, 우유, 튀김가루, 설탕, 단호박, 감자, 파슬리, 후추, 생크림, 맛술, 휘핑 생크림, 잔멸치, 버터, 호두, 다진 마늘, 참기름\n식사 유형: 아침식사\n매운 음식: X\n제외 음식: '
  },
  {
    role: 'assistant',
    content://4인분 1/4 1개, 1/2 1개 -> 1인분(1/16)
  ...
  },
  {
    role: 'user',
    content:
      '재료: 참기름, 간장, 설탕, 후추, 맛술, 휘핑 생크림, 생크림, 파슬리, 단호박, 소금, 호두, 튀김가루, 식용유, 다진 마늘, 감자, 버터, 올리고당, 양파, 잔멸치, 통깨, 우유\n식사 유형: 밑반찬\n매운 음식: X\n제외 음식: '
  },
  {
    role: 'assistant',
    content://4인분 1/8 1개, 1/2 2개
  ...
  },
  {
    role: 'user',
    content:
      '재료: 화이트 발사믹, 후춧가루, 건고추, 부라타 치즈, 청양고추, 고춧가루, 올리브오일, 마늘, 소금, 브라운 양송이버섯, 토마토, 그린 올리브, 홍고추, 고추기름, 타임\n식사 유형: 아침식사\n매운 음식: X\n제외 음식: '
  },
  {
    role: 'assistant',
    content://2인분 분수 x
  ...
  },
  {
    role: 'user',
    content:
      '재료: 브라운 양송이버섯, 올리브오일, 후춧가루, 소금, 고추기름, 고춧가루, 토마토, 마늘, 건고추, 부라타 치즈, 청양고추, 타임, 홍고추, 그린 올리브, 화이트 발사믹\n식사 유형: 안주\n매운 음식: X\n제외 음식: '
  },
  {
    role: 'assistant',
    content://2인분 1/2 1개
  ...
  },
  {
    role: 'user',
    content:
      '재료: 간장, 통깨, 단호박, 맛술, 잔멸치, 올리고당, 튀김가루, 우유, 후추, 파슬리, 식용유, 휘핑 생크림, 양파, 설탕, 버터, 생크림, 감자, 다진 마늘, 호두, 참기름, 소금\n식사 유형: 안주\n매운 음식: X\n제외 음식: '
  },
  {
    role: 'assistant',
    content://2인분 1/2 1개
